...
$(document).ready(function() {
    ...
    let controlHtml = `
			...
			<form action="" method="POST" accept-charset="utf-8" id="ds-form">
				<input type="file" id="ds-file-control">
			</form>
    ...
    $('#ds-info-control').addClass('display-none');
    $('#ds-btn-sign').prop('disabled', true);
